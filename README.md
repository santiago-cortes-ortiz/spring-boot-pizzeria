# spring-boot-pizzeria
![img.png](img.png)
## SQL
```
-- TRUNCATE TABLES
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE `pizzeria`.`tbl_order_items`;
TRUNCATE `pizzeria`.`tbl_orders`;
TRUNCATE `pizzeria`.`tbl_customers`;
TRUNCATE `pizzeria`.`tbl_pizzas`;
SET FOREIGN_KEY_CHECKS = 1;

-- INSERT CUSTOMERS
INSERT INTO `pizzeria`.`tbl_customers` (`id`, `name`, `address`, `email`, `phone_number`)
VALUES
...
-- INSERT PIZZAS
INSERT INTO `pizzeria`.`tbl_pizzas` (`id`, `name`, `description`, `price`, `vegetarian`, `vegan`, `available`)
VALUES
...
-- INSERT ORDERS
INSERT INTO `pizzeria`.`tbl_orders` (`id`, `id_customer`, `date`, `total`, `payment_method`, `additional_info`)
VALUES
...
-- INSERT ORDER ITEMS
INSERT INTO `pizzeria`.`tbl_order_items` (`id_order`, `id_item`, `id_pizza`, `quantity`, `price`)
VALUES
(1, 1, 1, 1, 23.0),
(1, 2, 4, 1, 19.95),
(2, 1, 2, 1, 18.5),
